        ...
        <section className="pt-10 md:pt-20 lg:pt-[200px]">
            <div className="container">
                <div className="relative mb-[14px] lg:mb-12">
                    ...
                    <div className="absolute top-1 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-between xl:top-10 xl:w-full">
                        <div className="flex flex-col items-end max-xl:hidden">
                            <div className="text-base leading-none mb-1.5">
                                {address}
                            </div>
                        ...
                        <div className="bg-white px-4 py-[14px] rounded-[128px] max-w-max lg:px-20 lg:py-14">
                            <div className="flex items-center">
                                ...
                                />
                                <h1 className="text-xl leading-none font-Gloock mx-2.5 lg:text-[80px] lg:leading-none lg:mx-12 2xl:text-[50px] 2xl:leading-none">
                                    {title}
                                </h1>
                                <div
                                    dangerouslySetInnerHTML={{
                        ...
                        <ContentManager
                            ...
                            className="text-xs leading-none text-[#8F8E88] text-right [&_strong]:inline-block [&_strong]:leading-none [&_strong]:font-normal [&_strong]:text-base [&_strong]:text-[#1e293b] [&_strong]:mb-1.5 max-xl:hidden md:[&_strong]:text-lg md:[&_strong]:leading-none lg:text-left"
                        />
                    </div>
                </div>
                <div className="flex items-start justify-between mb-6 xl:hidden">
                    ...
                    <ContentManager
                        items={open_time.nodes}
                        className="text-xs leading-none text-[#8F8E88] text-right [&_strong]:inline-block [&_strong]:leading-none [&_strong]:font-normal [&_strong]:text-base [&_strong]:text-[#1e293b] [&_strong]:mb-1.5 md:[&_strong]:text-lg md:[&_strong]:leading-none lg:text-left"
                    />
                </div>
