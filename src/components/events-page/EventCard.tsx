...
export const EventCard: React.FC<Props> = ({ card, bcmsConfig }) => {
    return (
        <article className="px-6 py-8 rounded-2xl bg-[#EDEBE1]">
            ...
            {card.cover_image && card.cover_image._id ? (
                <BCMSImage
                ...
                <div className="object-cover aspect-[1.25] w-full rounded-2xl overflow-hidden mb-4 bg-gray-300 flex items-center justify-center lg:aspect-[1.77] lg:mb-6">
